...
func (UnimplementedSnapshotServer) Generate(context.Context, *SignedSnapshotRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Generate not implemented")
}
func (UnimplementedSnapshotServer) Cancel(context.Context, *SignedSnapshotRequest) (*empty.Empty, error) {
